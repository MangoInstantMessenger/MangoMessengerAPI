...
namespace MangoAPI.DataAccess.Migrations
{
    ...
    [Migration("20210821140406_UserInformationSeedUpdate")]
    partial class UserInformationSeedUpdate
    {
            ...
            modelBuilder.Entity("MangoAPI.Domain.Entities.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Bio = "13 y. o. | C# pozer",
                            ConcurrencyStamp = "a65978e0-24d0-49b8-98f8-474455e63fe1",
                            DisplayName = "Khachatur Khachatryan",
                            Email = "xachulxx@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "XACHULXX@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEAwDAhdyvOPZmFpIeJWm8pbsTfHVsygJEVq86NXhp+Sx75cwraSdEWhknGnF19PRPw==",
                            PhoneNumber = "+374 775 55 43 10",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "5ee94644-fe98-491a-8a17-087adc2b8117",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "09e0729e-f72f-4a2b-aa0b-2919e42abdbd",
                            DisplayName = "razumovsky r",
                            Email = "kolosovp95@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "KOLOSOVP94@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEO5uoWnJC3RAzqtqrn5CxHYJ8wcO/oaDgEgMkPNiB5KMYwajwJZ1IGpVjlph+XGqaQ==",
                            PhoneNumber = "+48 743 615 532",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "63d30752-891d-48f1-b157-f8d2c992c3b9",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Bio = "Колбасятор.",
                            ConcurrencyStamp = "8cb3d45b-33e1-48c8-8772-c1bd2a8ed1ba",
                            DisplayName = "Мусяка Колбасяка",
                            Email = "kolbasator@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "KOLBASATOR@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEAOh846YjbEnLzUmtFScTmFWY4gPR/i2ncD5fmXXU/vGLx3oQo6HDepMdN+Kb19qxw==",
                            PhoneNumber = "+7 701 750 62 65",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "db8c4ee3-5ed0-434b-9d2e-6347ed749769",
                            TwoFactorEnabled = false,
                            UserName = "kolbasator"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Bio = "Дипломат",
                            ConcurrencyStamp = "9e8e25ff-f453-4432-8a76-5b133e75e05f",
                            DisplayName = "Amelit",
                            Email = "amelit@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "AMELIT@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEAUG/qCrlx3atno5h+V5R61x1HLpUhzMUm1Xhx3PXErYtyJfmu/NMHpiKIpzvTAAOg==",
                            PhoneNumber = "+1 202 555 0152",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "87e36072-0b0f-4d5c-8e2c-d77c3156cc7d",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "8b1d8dc8-5504-41dc-8de1-ade026815a81",
                            DisplayName = "Petro Kolosov",
                            Email = "petro.kolosov@wp.pl",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "PETRO.KOLOSOV@WP.PL",
                            PasswordHash = "AQAAAAEAACcQAAAAEJHoVUO7Az3IBoCYGI49hwuVqjKwMwKwpQo9m7MjGAYpR5GV3nYY4PWQux0HH2chnQ==",
                            PhoneNumber = "+48 743 615 532",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "d74bd5d6-9a36-47c0-9273-ad41452803fd",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "c9dba257-8303-46d9-b71d-fcb6df801981",
                            DisplayName = "Szymon Murawski",
                            Email = "szymon.murawski@wp.pl",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "SZYMON.MURAWSKI@WP.PL",
                            PasswordHash = "AQAAAAEAACcQAAAAEC22n0UnhZiG782mJp24nhQhJ30ZtZlNanICbAqAmgYMyYrAimfWt1/49ZJGcCAsnw==",
                            PhoneNumber = "+48 743 615 532",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "dd616ab6-af5b-4e2f-ab6b-0b505276d894",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Bio = "Third year student of WSB at Poznan",
                            ConcurrencyStamp = "27859c2c-429d-4c54-9c1e-dbe3b94cbae9",
                            DisplayName = "Illia Zubachov",
                            Email = "illia.zubachov@wp.pl",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ILLIA.ZUBACHOW@WP.PL",
                            PasswordHash = "AQAAAAEAACcQAAAAEOxg2Dt+y1yiXQ3QXUUxZDwNFp0uZhXMm2gb9YYJ8KwspwIP3cM/SKSEPtbDJEPNdA==",
                            PhoneNumber = "+48 352 643 123",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "19e51cc2-9c3b-425d-9959-ecb4667957b5",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Bio = "Third year student of WSB at Poznan",
                            ConcurrencyStamp = "4a00f668-09da-4e39-a1d2-90cc70398bce",
                            DisplayName = "Arslanbek Temirbekov",
                            Email = "arslanbek.temirbekov@wp.pl",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ARSLANBEK.TEMIRBEKOV@WP.PL",
                            PasswordHash = "AQAAAAEAACcQAAAAEAaiUg6HkqMKTVHaXA1mikGW0S14U9ClH0p8T5gwS00C3QAgBrdBdYz4lP4HsvGScA==",
                            PhoneNumber = "+48 278 187 781",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "fe003ef4-8b04-4782-a3dd-1c23caf27e11",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Bio = "Third year student of WSB at Poznan",
                            ConcurrencyStamp = "b1aa219f-90f5-4ad7-ba6e-9927e682ef8d",
                            DisplayName = "Serhii Holishevskii",
                            Email = "serhii.holishevskii@wp.pl",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "SERHII.HOLISHEVSKII@WP.PL",
                            PasswordHash = "AQAAAAEAACcQAAAAENcAbeuKdMubbQATviCV2z55jiVi6CK5Eiii8oolbS2oFoWOY8c3yghIz2zOoNjXXQ==",
                            PhoneNumber = "+48 175 481 653",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "58b6bc86-faac-4a7b-8b1b-93e33e0a960e",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "c5c1185c-8560-402e-b388-f9ba997d2229",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "4a760214-c1df-4336-a503-ce55e6b01482",
                            Name = "Unverified",
