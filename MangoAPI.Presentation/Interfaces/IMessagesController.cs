...
namespace MangoAPI.Presentation.Interfaces
{
    ...
    {
        Task<IActionResult> GetChatMessages(string id, CancellationToken cancellationToken);
        ...
        Task<IActionResult> DeleteMessage(string id, CancellationToken cancellationToken);
    }
}