...
namespace MangoAPI.Infrastructure.Services
{
    public class JwtRefreshService : IJwtRefreshService
    {
        ...
        public async Task<VerifyTokenResult> VerifyUserRefreshTokenAsync(string refreshTokenId,
            RequestMetadata requestMetadata, CancellationToken cancellationToken)
        {
        ...
        public async Task<RevokeTokenResult> RevokeRefreshTokenAsync(string refreshTokenId,
            CancellationToken cancellationToken)
        {
            ...
            if (token is null)
            {
                return new RevokeTokenResult {Success = false};
            }
            ...
            return new RevokeTokenResult {Success = true};
        }
    }
}