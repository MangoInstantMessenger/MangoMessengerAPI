...
namespace MangoAPI.BusinessLogic.ApiCommands.Users
{
    public class UpdateProfilePictureCommandHandler 
        : IRequestHandler<UpdateProfilePictureCommand, GenericResponse<ResponseBase,ErrorResponse>>
    {
        ...
        public async Task<GenericResponse<ResponseBase,ErrorResponse>> Handle(UpdateProfilePictureCommand request, 
