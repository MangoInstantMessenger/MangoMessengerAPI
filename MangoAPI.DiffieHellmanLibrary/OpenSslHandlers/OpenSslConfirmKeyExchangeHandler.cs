...
public class OpenSslConfirmKeyExchangeHandler : BaseHandler
{
    public OpenSslConfirmKeyExchangeHandler(HttpClient httpClient, TokensService tokensService) : base(httpClient,
        tokensService)
    {
    }
