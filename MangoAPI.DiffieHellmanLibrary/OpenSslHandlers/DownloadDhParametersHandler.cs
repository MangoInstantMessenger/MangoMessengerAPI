...
public class DownloadDhParametersHandler : BaseHandler, IDownloadDhParametersHandler
{
    public DownloadDhParametersHandler(HttpClient httpClient) : base(httpClient)
    {
    }
