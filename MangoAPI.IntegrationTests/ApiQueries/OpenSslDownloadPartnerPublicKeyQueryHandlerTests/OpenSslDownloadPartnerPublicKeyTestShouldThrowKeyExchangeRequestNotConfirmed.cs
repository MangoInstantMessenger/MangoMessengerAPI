...
public class OpenSslDownloadPartnerPublicKeyTestShouldThrowKeyExchangeRequestNotConfirmed : IntegrationTestBase
{
    private readonly Assert<OpenSslDownloadPartnerPublicKeyResponse> _assert = new();

    [Fact]
    public async Task OpenSslDownloadPartnerPublicKeyTest_ShouldThrowKeyExchangeRequestNotConfirmed()
    {
