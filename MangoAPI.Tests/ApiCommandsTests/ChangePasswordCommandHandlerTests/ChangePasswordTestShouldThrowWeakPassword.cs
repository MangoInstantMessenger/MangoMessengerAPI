...
public class ChangePasswordTestShouldThrowWeakPassword: ITestable<ChangePasswordCommand, ResponseBase>
{
    ...
    [Fact]
    public async Task ChangePasswordTestShouldThrow_WeakPassword()
    {
        Seed();
    ...
    {
        var userManagerMock = MockedObjects.GetUserServiceMock();
